    ...
    <div class="container">
        <nav class="navbar navbar-default navbar-fixed-top navbar-inverse" role="navigation">
            <div class="container">
                ...
                <div class="navbar-header">
                    <a href="index.html" class="navbar-brand headerFont text-lg">Vote Smart</a>
                </div>
        ...
        <div class="container" style="padding-top:150px;">
            <div class="row">
                ...
                <div class="col-sm-4 text-center rounded-box" style="border:2px solid gray; padding:50px;">
                    <?php
                    require('config.php');
                    ...
                    if(isset($_POST["submit"])){
                        ...
                        if(mysqli_query($conn, $sql)){
                            ...
                            echo "<h3 class='text-info specialHead text-center'><strong> YOUR VOTE IS IN!</strong></h3>";
