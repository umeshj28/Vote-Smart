  ...
  <div class="container">
    <nav class="navbar navbar-default navbar-fixed-top navbar-inverse" role="navigation">
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="example-nav-collapse">        
          ...
          <button type="submit" class="btn btn-success navbar-right navbar-btn"><span class="normalFont"><strong>Admin</strong></span></button>
        </div>
    ...
    <div class="container" style="padding-top:150px;">
      <div class="row">
        ...
        <div class="col-sm-4 text-center" style="border:2px solid rgb(59, 103, 184); padding:50px; border-radius: 10%;">
...
<?php
  ...
  if($rows == 1) {
    ...
    $sql = "UPDATE tbl_admin SET admin_password='$new' WHERE admin_username='admin'"; // =============EDIT *SESSSION_USERNAME *
